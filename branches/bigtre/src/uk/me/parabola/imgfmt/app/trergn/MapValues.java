...
public class MapValues {
	...
	public void calculate() {
		// Done in this order so we can reuse values that are calculated earlier.
		thirdValue();
		fourthValue();
		firstValue();
		secondValue();
	...
	private void addOffset() {
		...
		int n = mapidNibble(1) + mapidNibble(3) + mapidNibble(5) + mapidNibble(7);
		System.out.println("raw is " + n);
	...
	private void firstValue() {
		...
		out[0] = (byte) (mapidNibble(4) + v3[0]);
		out[1] = (byte) (mapidNibble(5) + v3[1]);
		out[2] = (byte) (mapidNibble(6) + v3[2]);
		out[3] = (byte) (mapidNibble(7) + v3[3]);
	...
	private void secondValue() {
		...
		out[4] = (byte) (v3[4] + mapidNibble(0));
		out[5] = (byte) (v3[5] + mapidNibble(1));
		out[6] = (byte) (v3[6] + mapidNibble(2));
		out[7] = (byte) (v3[7] + mapidNibble(3));
	}

	/**
	 * This is just the hex digits of the map id in a given order
